...
{
  /// <summary>
  /// This class tracks the state of an Outlook Explorer window for your add-in and ensures that what
  /// happens in this window is handled correctly.
  /// </summary>
  class OutlookExplorer
  {
    ...
    /// <summary>
    /// Event Handler for BeforeFolderSwitch event
    /// </summary>
    /// <param name="NewFolder"></param>
    /// <param name="Cancel"></param>
    void m_Window_BeforeFolderSwitch(object NewFolder, ref bool Cancel)
    {
      RaiseInvalidateControl("MyContextMenuFolder");
    }
    ...
    {
    if (InvalidateControl != null)  // this check is reccomended to ensure that one or more listener objects exist!
